...
- [**itsmostafa/typesafe-mcp**](https://github.com/itsmostafa/typesafe-mcp) — MCP 连接器：让任意 AI agent 直接调用 Jev（`Go`，303★）
...
- [《Jev 工程学：为 coding agent 而作》中文翻译（yibie）](https://github.com/yibie/jev-engineering-zh) — Diogo Almeida 设计笔记的完整中文翻译（独立汇编，123★）
