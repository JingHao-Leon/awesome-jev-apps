...
- 收录标准转向「有趣优先」：新增「趣味与实验」板块（人机对战、压价实验、飞行演示、输入法切换脑洞、MuJoCo 具身实验台、院内病历结构化）。

### 新增

- 7 条条目（共 75 条）：[hermes-jev-skills](https://github.com/kerpopule/hermes-jev-skills)（468★，agent 小决策第二大脑）+ 趣味与实验板块 6 条。
